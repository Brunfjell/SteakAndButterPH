Public Class Administrator
    ...
    Sub LoadDashboard()
        ...
        Try
            ...
            Command.CommandText = "SELECT * FROM ExpirationAlert"
            Adapter.SelectCommand = Command
            NETable.Clear()
            Adapter.Fill(NETable)
            ExpirationDGV.DataSource = NETable

            Command.CommandText = "SELECT * FROM stockalert"
            Adapter.SelectCommand = Command
            CSTable.Clear()
            Adapter.Fill(CSTable)
            StockDGV.DataSource = CSTable
            Connection.Close()
    ...
    Private Sub EditBtn_Click(sender As Object, e As EventArgs) Handles EditBtn.Click
        ...
        EditProductForm.ProductNameInput.Text = ProductsDGV.Item("product_name", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.QuantityInput.Text = ProductsDGV.Item("prod_quantity", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.PriceInput.Text = ProductsDGV.Item("price", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.SupplierIDInput.Text = ProductsDGV.Item("supplier_ID", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.BestBeforeDate.Text = ProductsDGV.Item("Best_Before", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.ExpirationDate.Text = ProductsDGV.Item("Expiration_Date", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.CriticalLvlInput.Text = ProductsDGV.Item("Critical_Level", ProductsDGV.CurrentRow.Index).Value
    End Sub
