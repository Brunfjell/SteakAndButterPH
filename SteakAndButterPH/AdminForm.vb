...
Public Class AdminForm
    ...
    'SISO HIDDEN DASHBOARD
    'LOC  = 885, 53
    'SIZE = 30,30

    Public StorageSum As Integer = 0
    ...
    Private Sub DashboardBtn_Click(sender As Object, e As EventArgs) Handles DashboardBtn.Click
        ...
        EmployeesBtn.FillColor = Color.FromArgb(220, 50, 50, 50)
    ...
    Private Sub TransactionsBtn_Click(sender As Object, e As EventArgs) Handles TransactionsBtn.Click
        ...
        OpenConnection()
        Try
            Command.CommandText = "SELECT deposit_ID AS 'Deposit ID', deposit_date AS 'Deposit Date', supplier_ID AS 'Supplier ID', product_name AS 'Product Name', product_quantity AS 'Quantity', supplier_contact AS 'Contact Number' FROM deposit_tbl"
            Adapter.SelectCommand = Command
            DTable.Clear()
            Adapter.Fill(DTable)
    ...
    Private Sub EmployeesBtn_Click(sender As Object, e As EventArgs) Handles EmployeesBtn.Click
        EmployeesBtn.FillColor = Color.FromArgb(170, 140, 100, 100)
        ...
        EmployeesPanel.Size = New Size(979, 652)
        EmployeesPanel.Location = New Point(209, 45)
        ...
        SuppliersPanel.Visible = False
        TransactionsPanel.Size = New Size(25, 25)
        TransactionsPanel.Location = New Point(315, 725)
        TransactionsPanel.Visible = False
    ...
    Private Sub AddProductBtn_Click(sender As Object, e As EventArgs) Handles AddProductBtn.Click
        AddProductFormA.Show()
    End Sub

    Private Sub StockIn_Click(sender As Object, e As EventArgs) Handles StockIn.Click
        StockInForm.StockInInput.Text = ProductsDGV.Item("Product Name", ProductsDGV.CurrentRow.Index).Value
        StockInForm.Show()
    End Sub

    Private Sub StockOutBtn_Click(sender As Object, e As EventArgs) Handles StockOutBtn.Click
        StockOutForm.StockOutInput.Text = ProductsDGV.Item("Product Name", ProductsDGV.CurrentRow.Index).Value
        StockOutForm.Show()
    End Sub
    ...
    Private Sub EditBtn_Click(sender As Object, e As EventArgs) Handles EditBtn.Click
        ...
        EditProductForm.ProductNameInput.Text = ProductsDGV.Item("Product Name", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.QuantityInput.Text = ProductsDGV.Item("Quantity", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.PriceInput.Text = ProductsDGV.Item("Price", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.SupplierIDInput.Text = ProductsDGV.Item("Supplier ID", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.BestBeforeDate.Text = ProductsDGV.Item("Best Before", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.ExpirationDate.Text = ProductsDGV.Item("Expiration Date", ProductsDGV.CurrentRow.Index).Value
        EditProductForm.CriticalLvlInput.Text = ProductsDGV.Item("Critical Level", ProductsDGV.CurrentRow.Index).Value
    End Sub
    ...
    Private Sub SEditBtn_Click(sender As Object, e As EventArgs) Handles SEditBtn.Click
        EditSupplierForm.Show()
        EditSupplierForm.CompanyNameInput.Text = SuppliersDGV.Item("Company Name", SuppliersDGV.CurrentRow.Index).Value
        EditSupplierForm.AddressInput.Text = SuppliersDGV.Item("Address", SuppliersDGV.CurrentRow.Index).Value
        EditSupplierForm.EmailInput.Text = SuppliersDGV.Item("Email Address", SuppliersDGV.CurrentRow.Index).Value
        EditSupplierForm.ContactNumInput.Text = SuppliersDGV.Item("Contact Number", SuppliersDGV.CurrentRow.Index).Value
    End Sub
    ...
    Private Sub SRemoveBtn_Click(sender As Object, e As EventArgs) Handles SRemoveBtn.Click
        Dim delConfirm As String
        delConfirm = MsgBox("Delete the Supplier?", vbYesNo)
        If (delConfirm = vbYes) Then
    ...
    Private Sub SODeleteBtn_Click(sender As Object, e As EventArgs) Handles SODeleteBtn.Click
        Dim delConfirm As String
        ...
        If (delConfirm = vbYes) Then
            ...
            Try
                Command.Connection = Connection
                Command.CommandText = "DELETE FROM withdraw_tbl WHERE withdraw_ID LIKE '%" & StockOutDGV.Item("Withdraw ID", StockOutDGV.CurrentRow.Index).Value & "%' "
                Command.ExecuteNonQuery()
                MsgBox("Removed")

                Command.CommandText = "SELECT withdraw_ID AS 'Withdraw ID', withdraw_date AS 'Withdraw Date', supplier_ID AS 'Supplier ID', product_name AS 'Product Name', product_quantity AS 'Quantity', supplier_contact AS 'Contact Number' FROM withdraw_tbl"
                Adapter.SelectCommand = Command
                WTable.Clear()
                Adapter.Fill(WTable)
    ...
    Private Sub SOSearch_TextChanged(sender As Object, e As EventArgs)
        ...
        Try
            Command.Connection = Connection
            Command.CommandText = "SELECT withdraw_date AS 'Withdraw Date', supplier_ID AS 'Supplier ID', product_name AS 'Product Name', product_quantity AS 'Quantity', supplier_contact AS 'Contact Number' FROM withdraw_tbl WHERE company_name LIKE '%" & SOSearch.Text & "%'"
            Adapter.SelectCommand = Command
            WTable.Clear()
            Adapter.Fill(WTable)
            StockOutDGV.DataSource = WTable
    ...
    Private Sub SIDeleteBtn_Click(sender As Object, e As EventArgs) Handles SIDeleteBtn.Click
        Dim delConfirm As String
        delConfirm = MsgBox("Delete the selected row?", vbYesNo)
        If (delConfirm = vbYes) Then
            ...
            Try
                Command.Connection = Connection
                Command.CommandText = "DELETE FROM deposit_tbl WHERE deposit_ID LIKE '%" & StockInDGV.Item("Deposit ID", StockInDGV.CurrentRow.Index).Value & "%' "
                Command.ExecuteNonQuery()
                MsgBox("Removed")
    ...
    Private Sub SISearch_TextChanged(sender As Object, e As EventArgs) Handles SISearch.TextChanged
        ...
        Try
            Command.Connection = Connection
            Command.CommandText = "SELECT deposit_date AS 'Deposit Date', supplier_ID AS 'Supplier ID', product_name AS 'Product Name', product_quantity AS 'Quantity', supplier_contact AS 'Contact Number' FROM deposit_tbl WHERE company_name LIKE '%" & SISearch.Text & "%'"
            Adapter.SelectCommand = Command
            DTable.Clear()
            Adapter.Fill(DTable)
            StockInDGV.DataSource = DTable
    ...
    Private Sub EDeleteBtn_Click(sender As Object, e As EventArgs) Handles EDeleteBtn.Click
        ...
        If (delConfirm = vbYes) Then
            ...
            Try
                ...
                Command.CommandText = "SELECT employee_ID AS 'Employee ID', firstname AS 'First Name', lastname AS 'Last Name', address AS 'Address', emailAddress AS 'Email Address', contactNum AS 'Contact Number', privilege AS 'Privilege' FROM employee_tb"
                Adapter.SelectCommand = Command
                ETable.Clear()
                Adapter.Fill(ETable)
                EmployeesDGV.DataSource = ETable
    ...
    Private Sub EEditBtn_Click(sender As Object, e As EventArgs) Handles EEditBtn.Click
        ...
        EditEmployeeForm.FirstNameInput.Text = EmployeesDGV.Item("First Name", EmployeesDGV.CurrentRow.Index).Value
        EditEmployeeForm.LastNameInput.Text = EmployeesDGV.Item("Last Name", EmployeesDGV.CurrentRow.Index).Value
        EditEmployeeForm.AddressInput.Text = EmployeesDGV.Item("Address", EmployeesDGV.CurrentRow.Index).Value
        EditEmployeeForm.EmailInput.Text = EmployeesDGV.Item("Email Address", EmployeesDGV.CurrentRow.Index).Value
        EditEmployeeForm.ContactNumInput.Text = EmployeesDGV.Item("Contact Number", EmployeesDGV.CurrentRow.Index).Value
    End Sub
