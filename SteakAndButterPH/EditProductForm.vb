    ...
    Private Sub AddBtn_Click(sender As Object, e As EventArgs) Handles AddBtn.Click
        ...
        Try
            ...
            Command.CommandText = "UPDATE product_tbl  SET product_name = '" & ProductNameInput.Text & "', prod_quantity = '" & QuantityInput.Text & "',
                                           ...
                                           , Expiration_Date = " & Format(ExpirationDate.Value, "yyyy-MM-dd") & " , Critical_Level = '" & CriticalLvlInput.Text & "'WHERE product_ID = '" & AdminForm.ProductsDGV.Item("Product ID", AdminForm.ProductsDGV.CurrentRow.Index).Value & "'"
